...
public @interface InterfaceClient {
	...
	/**
	 * Declares the type filter to be used as an {@linkplain InterfaceClient#includeFilters
	 * include filter} or {@linkplain InterfaceClient#excludeFilters exclude filter}.
